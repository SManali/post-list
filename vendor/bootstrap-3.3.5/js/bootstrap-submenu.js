...
(function(factory) {
  ...
  $.extend(SubmenuItem.prototype, Item.prototype, {
    ...
    "open": function() {
      var submenu = this.$main.find("ul")[0],
          container = $(".me-container > .container")[0],
          submenuRect, containerRect;
      this.$main.addClass('open');
      submenuRect = submenu.getBoundingClientRect();
      containerRect = container.getBoundingClientRect();
      if(submenuRect.left + submenuRect.width > containerRect.width + containerRect.left) {
